...
#      "ansible-pull -i localhost, -U https://github.com/Aswanidevm/roboshop-ansible.git main.yml -e env=${var.env} -e role_name=${var.component}"
#     ]
#   }
# }
...
resource "aws_instance" "test" {
   ...
   tags = merge ({ Name = "test-${var.env}"}, var.tags )
}
